...
PubMed_Link <- paste0("To see these selected articles in <a href = 'https://www.ncbi.nlm.nih.gov/pubmed/?term=",PMIDs,"'> PubMed click here </a>")
...
```{r run all Rmd without knit, include=FALSE}
source_rmd <- function(rmd_file){
  knitr::knit(rmd_file, output = tempfile(), envir = globalenv())
}

list_of_Rmd <- list.files(path = here::here(), pattern = "Recent.Rmd")

purrr::map(.x = here::here("", list_of_Rmd), .f = source_rmd)

...
PubMed_Link <- paste0("To see these selected Pancreas articles in <a href = 'https://www.ncbi.nlm.nih.gov/pubmed/?term=",PMIDs,"'> PubMed click here </a>")

write(x = PubMed_Link, file = here::here("data","PubMed_Link.txt"))
...
Lens_Link <- paste0("To see these selected Pancreas articles in <a href = 'https://www.lens.org/lens/scholar/search/results?q=",PMID_Lens,"&toYear=2020&fromYear=1950&dateFilterField=year_published&filterMap=%7B%7D&preview=true'> Lens.org click here </a>")

write(x = Lens_Link, file = here::here("data","Lens_Link.txt"))

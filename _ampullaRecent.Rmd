...
```{r ampulla 32698796, include=FALSE}

PMID_32698796 <- RefManageR::ReadPubMed('32698796', database = 'PubMed')

citation_32698796 <- paste0(PMID_32698796$journal,' ', PMID_32698796$year, ' ', PMID_32698796$month,';', PMID_32698796$volume,'(', PMID_32698796$number,'):', PMID_32698796$pages)

PubMed_32698796 <- paste0(PubMedString, PMID_32698796$eprint)

doi_32698796 <- paste0(doiString, PMID_32698796$doi)
